    ...
    <div>
      <div className="flex pl-8 relative">
        ...
        <div className="w-[13.58rem] h-[20.87rem] relative">
          ...
          <div className="absolute top-0 left-0"> Attribute Category1</div>
        </div>
        ...
        <div className="w-[13.58rem] h-[20.87rem] relative">
          ...
          <div className="absolute top-0 left-0">Attribute Category2</div>
        </div>

        {/* 세번째 카테고리 */}
        <div className="w-[28.46rem] h-[20.88 rem] relative">
          <img className="w-full h-full" src={lineBox3} />
          <div className="absolute top-0 left-0"> Attribute Category3</div>
        </div>
